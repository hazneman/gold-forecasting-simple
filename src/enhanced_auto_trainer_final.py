    ...
    def engineer_features(self, df):
        ...
        try:
            ...
            for period in [1, 3, 5, 7, 14, 21, 30, 60, 90]:
                ...
                data[f'volatility_{period}d'] = data['Close'].rolling(period).std()
            ...
            data['support_distance'] = (data['Close'] - data['low_20']) / data['Close']
            data['resistance_distance'] = (data['high_20'] - data['Close']) / data['Close']
